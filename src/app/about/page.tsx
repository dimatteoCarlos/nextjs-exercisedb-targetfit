    ...
    dark:bg-gray-800 dark:text-white h-full lg:h-lvh'
      ...
      '
        ...
        '
          >
            ...
            <p className='px-3 text-xl'>
              ...
              maximize their workouts by focusing on the most effective
              exercises for specific muscle groups. <br></br>
              <br></br> Whether you&apos;re aiming to build strength, enhance
              endurance, or sculpt your physique, our guides are designed to
              help you achieve your fitness goals efficiently and safely.
            </p>
          </div>
        </div>
        {/* <p>
        ...
        <p className='text-xl dark:text-gray-300 pt-5 px-5 lg:pl-0'>
          ...
          your fitness journey with our platform. Your commitment to training
          and improving your health inspires us, and we are excited to support
