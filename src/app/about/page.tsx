...
function About() {
  return (
    ...
    >
      ...
      <div className='flex flex-col items-center lg:flex-row lg:text-lg
      '>
        ...
        <div className=' dark:text-gray-200 flex-1 p-3 text-lg items-center
        ...
        '>
          ...
          for specific muscle groups. <br></br><br></br> Whether you&apos;re aiming to
          build strength, enhance endurance, or sculpt your physique, our guides
          are designed to help you achieve your fitness goals efficiently and
          safely.
          </p>
        </div>
      </div>
